...
const TICKET_STEPS: TrackStep[] = [
  ...
  },
  {
    ...
    body: 'Evidence, plan, and audit trail sit with the ticket before anything opens as an MR.',
...
const MODEL_STEPS: TrackStep[] = [
  {
    ...
    body: 'Choose org defaults or a custom training path — preference starts the model lifecycle.',
  ...
  },
  {
    ...
    body: 'Training payloads stay inside the clearing and policy path. Shadow exports never feed the model.',
    icon: <Shield size={16} strokeWidth={1.75} aria-hidden="true" />,
  },
  {
    id: 'train',
    ...
    body: 'A custom model is trained from curated, cleared answers — still gated before anyone can use it.',
  ...
  },
  {
    ...
    body: 'Once approved, the org can try the custom model on governed runs — still behind PII and policy.',
