...
production uses the isolated Project B `aplifyai-prod-2026`. See
...
- `e2e.yml`: callable/manual/PR Playwright gate for the `aplifyai-web` workspace
...
- `GCP_ARTIFACT_REPOSITORY` (for example, `aplifyai`)
